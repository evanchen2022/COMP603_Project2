...
public class TicketSummaryPage extends javax.swing.JFrame
{
        ...
        try
        {
            while (rs.next())
            {
                String passengerInfo = String.format("First Name: %s\nLast Name: %s\nPassport Number: %s\nDOB: %s\nAddress: %s\nPhone Number: %s\nEmail: %s\nClient Number: %s",
                        rs.getString("firstName"), rs.getString("lastName"), rs.getString("passportNumber"), rs.getString("dob"),
                        rs.getString("address"), rs.getString("phoneNumber"), rs.getString("email"), rs.getString("clientNumber"));
    ...
    private void initComponents()
    {
        ...
        setPreferredSize(new java.awt.Dimension(595, 467));
